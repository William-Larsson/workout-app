...
/**
 * Created by ArmanSo on 2017-04-16.
 * Source: https://gist.github.com/armanso/f34d67e5cfbf379db7f0ff29c68dd29c
 *
...
public class ViewUtil {
    ...
    /**
     * Create a background view with custom colors,
     * radix, drop-shadow color and elevation attributes.
     * @param view = the view
     * @param backgroundColor = color
     * @param cornerRadius = radix
     * @param shadowColor = drop shadow color
     * @param elevation = material "height" value
     * @param shadowGravity = Gravity.CENTER/TOP/BOTTOM
     * @return = drawable view
     */
